...
namespace Andersc.AlgorithmInCs.Common.Extensions
{
    public static class ArrayExtension
    {
        ...
        public static void Visit<T>(this T[] array, Action<T> visit)
        {
        ...
        public static void PrintToConsole<T>(this T[] array, string separator = "************")
        {
            Console.WriteLine();
            ...
            Visit(array, elem => Console.Write("{0} ", elem));
